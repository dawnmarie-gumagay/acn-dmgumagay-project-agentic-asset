...
spec:
  ...
  template:
    ...
    remediation_log["attempts"][-1]["diagnosis"] = "OOMKilled - Memory limit too low (512Mi insufficient for 580Mi usage)"
    remediation_log["attempts"][-1]["remediation"] = "Increased memory limit from 512Mi to 1Gi"
