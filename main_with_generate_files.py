...
from tasks import create_analysis_task, create_generation_task, create_validation_task, create_project_task, create_file_task
...
def run_crew(user_prompt):
    ...
    project_task = create_project_task()
    ...
    project_task.context = [generation_task]
    file_task.context = [project_task]
    validation_task.context = [file_task]
